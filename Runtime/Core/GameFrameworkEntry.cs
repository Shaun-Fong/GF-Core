...
namespace GF
{
    ...
    public static class GameFrameworkEntry
    {
        ...
        public static T GetModule<T>() where T : class
        {
            ...
            if (!interfaceType.FullName.StartsWith("GF.", StringComparison.Ordinal))
            {
                throw new GameFrameworkException(Utility.Text.Format("You must get a GF module, but '{0}' is not.", interfaceType.FullName));
            }
            ...
            if (moduleType == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("Can not find GF module type '{0}'.", moduleName));
            }
